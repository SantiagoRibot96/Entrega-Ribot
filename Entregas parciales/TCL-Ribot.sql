...
START TRANSACTION;
    ...
    DELETE from entregas where id_chofer = 5;
-- ROLLBACK;
COMMIT ;
...
START TRANSACTION;
	INSERT INTO productos VALUES (7, 'Brasero', 5000, 23);
	INSERT INTO productos VALUES (8, 'Canasto', 200, 53);
	INSERT INTO productos VALUES (9, 'Madera', 150, 200);
	INSERT INTO productos VALUES (10, 'Plancha', 2000, 10);
	SAVEPOINT sp1;
    
	INSERT INTO productos VALUES (11, 'Espatula', 500, 15);
	INSERT INTO productos VALUES (12, 'Pinza', 500, 20);
	INSERT INTO productos VALUES (13, 'Pinza grande', 700, 22);
	INSERT INTO productos VALUES (14, 'Plancha grande', 3000, 12);
	SAVEPOINT sp2;
